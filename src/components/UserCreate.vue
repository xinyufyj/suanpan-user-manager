  ...
  <a-modal 
    ...
    :footer="null">
      ...
      <a-form-item :wrapper-col="{ span: 14, offset: 4 }">
        ...
        <a-button style="margin-left: 10px" type="primary" :loading="loading" @click="createUser">确定</a-button>
      </a-form-item>
    </a-form>
  </a-modal>
</template>
      ...
      this.$refs.model.validate().then(() => {
        ...
        addUser(param).then(res => {
          if(res.data && (res.data.code == 1)) {
            this.$emit('success', {username: param.username, password: this.modelState.password})
